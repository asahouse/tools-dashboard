...
public class LoginConnection {
	...
	private void init() {
		...
		try {
			//rsa.loadPublicKeyFromFile(FileUtil.getFileFromResource("/config/props/" + PUBLIK_KEY_NAME));
			//rsa.loadPublicKeyFromFile(FileUtil.getInputStreamFromResource("apiPub.key"));
			rsa.loadPublicKeyFromString(FileUtil.getStringFromResource(PUBLIK_KEY_NAME));
